Shader "Hidden/Edge Detection"
{
    Properties
    {
        ...
        _DepthSensitivity ("Depth Sensitivity", Float) = 200.0
        _NormalSensitivity ("Normal Sensitivity", Float) = 4.0
        _LuminanceSensitivity ("Luminance Sensitivity", Float) = 0.5
    }
    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            half4 frag(Varyings IN) : SV_TARGET
            {
                ...
                float normal_threshold = 1 / _NormalSensitivity;
                edge_normal = edge_normal > normal_threshold ? 1 : 0;
                
                float luminance_threshold = 1 / _LuminanceSensitivity;
